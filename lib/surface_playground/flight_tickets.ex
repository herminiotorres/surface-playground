defmodule SurfacePlayground.FlightTickets do
  alias SurfacePlayground.Booking
  ...
  def new_booking_changes do
    ...
    Booking.one_way_flight_changeset(booking)
  end
  ...
  defp booking_message(booking) do
    case booking.flight_type do
      ...
      "return flight" ->
        "You have booked a return flight departing #{booking.departure} and returning #{booking.return}"
    end
  end
end
